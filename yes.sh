...
echo "exec --no-startup-id dunst" >> /home/$username/.config/i3/config
echo "exec --no-startup-id picom -b" >> /home/$username/.config/i3/config
echo "exec --no-startup-id nitrogen --restore" >> /home/$username/.config/i3/config
echo "exec --no-startup-id /usr/bin/lxqt-policykit-agent &" >> /home/$username/.config/i3/config
